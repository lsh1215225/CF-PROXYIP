...
def get_cf_speed_test_ip(timeout=10, max_retries=5):
    for attempt in range(max_retries):
        try:
            # 发送 GET 请求，设置超时
            response = requests.get('https://raw.githubusercontent.com/leung7963/iptest/main/proxyip.txt', timeout=timeout)
            # 检查响应状态码
...
def main():
    ...
    lines = ip_addresses_str.split('\n')
    ip_addresses = lines[0]
